...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #4169e1 0%, #add8eb 100%);
        }
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            <div class="pl-4 flex items-center"><a
                    class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    href="#">
                    SekolahXYZ
                </a></div>
            <div class="block lg:hidden pr-4"><button id="nav-toggle"
                    class="flex items-center p-1 text-pink-800 hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"><svg
                        class="fill-current h-6 w-6" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <title>Menu</title>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3"><a class="inline-block py-2 px-4 text-black font-bold no-underline"
                            href="#">Beranda</a></li>
                    <li class="mr-3"><a
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <br><br>
                <h1 class="my-4 text-5xl font-bold leading-tight">Selamat Datang di SekolahXYZ.</h1>
                <p class="text-black mb-8">SekolahXYZ merupakan sekolah unggulan yang berada di
                    kota X,
                    yang memiliki fasilitas mulai dari ruangan yang nyaman hingga lapangan olahraga
                    yang mempuni. <br /><br /></p>
            </div>
            <div>
                <h3 class="text-3xl font-medium text-gray-700">Data Sekolah</h3>
                <div class="mt-4">
    ...
    <div class="relative -mt-12 lg:-mt-24"><svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <center><img width="175" src="img/sekolahxyz.png"></center>
            <div class="w-full mb-4">
                <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">SekolahXYZ </h3>
                    <p class="text-gray-600 mb-8">SekolahXYZ merupakan sekolah unggulan yang berada di kota
                        X,
                        yang memiliki fasilitas mulai dari ruangan yang nyaman hingga lapangan olahraga yang
                        mempuni. <br /><br /></p>
                    <a class="mx-auto lg:mx-0 hover:underline bg-gray-300 text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out mt-4"
                        href="register">
                        Register</a>
                </div>
                <div class="w-full sm:w-1/2 p-6"><svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6"><svg class="w-5/6 sm:h-64 mx-auto"
                        viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">SekolahXYZ </h3>
                        <p class="text-gray-600 mb-8">SekolahXYZ merupakan sekolah unggulan yang berada di
                            kota X,
                            yang memiliki fasilitas mulai dari ruangan yang nyaman hingga lapangan olahraga
                            yang mempuni. <br /><br /></p>
                        <a class="mx-auto lg:mx-0 hover:underline bg-gray-300 text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out mt-4"
            ...
            <div class="container mx-auto px-8">
                <div class="w-full flex flex-col md:flex-row py-6">
                    <div class="flex-1 mb-6 text-black">
                        <center><img width="125" src="img/sekolahxyz.png"></center>
                    </div>
                    <div class="flex-1">
                        <p class="uppercase text-gray-500 md:mb-6">Links</p>
                        <ul class="list-reset mb-6">
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0"><a href="#"
